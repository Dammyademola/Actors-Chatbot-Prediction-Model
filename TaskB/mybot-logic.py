...
integrity_check_result = ResolutionProver().prove(integrity_check_expr, kb, verbose=False)
        ...
        if answer and answer[0] == "#":
            ...
            if cmd == 0:
                ...
                if contradiction_check:
                    print("Error: The provided information contradicts with existing knowledge.")
                else:
                    kb.append(expr)
